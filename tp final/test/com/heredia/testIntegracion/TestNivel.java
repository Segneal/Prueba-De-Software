...
public class TestNivel {
	...
	@Test
	public void testChoqueNivel() {
		assertTrue("Existen colisiones?",nivel.huboChoque());		
	}
	
	@Test
	public void testAterrizarAviones() {
		assertTrue("Existen aviones a aterrizar?",nivel.aterrizarAviones()==0);
	}
	
	@Test
	public void testPistasAdecuadas() {
		assertTrue("Existe pista adecuada para avion?",nivel.tienePistaAdecuada(avion1));
	}
